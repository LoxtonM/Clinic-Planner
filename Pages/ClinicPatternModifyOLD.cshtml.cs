...
{
    public class ClinicPatternModifyOLDModel : PageModel
    {
        ...
        public ClinicPatternModifyOLDModel(ClinicalContext context, CPXContext cpxContext, IConfiguration config)
        {
            _context = context;    
