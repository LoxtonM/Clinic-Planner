...
{
    public class ClinicLetterPrintOLDModel : PageModel
    {
        ...
        public ClinicLetterPrintOLDModel(ClinicalContext context, CPXContext cpxContext, DocumentContext documentContext, IConfiguration config)
        {
            _context = context;
