...
{
    public class ClinicListSelectOLDModel : PageModel
    {
        ...
        public ClinicListSelectOLDModel(ClinicalContext context, CPXContext cpxContext, DocumentContext documentContext, IConfiguration config)
        {
            _context = context;
