...
{
    public class ClinicLettersAndListsOLDModel : PageModel
    {
        ...
        public ClinicLettersAndListsOLDModel(ClinicalContext context, CPXContext cpxContext, DocumentContext docContext, IConfiguration config)
        {
            _context = context;
