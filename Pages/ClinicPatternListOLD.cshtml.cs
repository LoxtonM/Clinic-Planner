...
{
    public class ClinicPatternListOLDModel : PageModel
    {
        ...
        public ClinicPatternListOLDModel(ClinicalContext context, CPXContext cpxContext, DocumentContext documentContext)
        {
            _context = context;
