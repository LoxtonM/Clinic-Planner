...
{
    public class ClinicListPrintOLDModel : PageModel
    {
        ...
        public ClinicListPrintOLDModel(ClinicalContext context, CPXContext cPXContext, DocumentContext documentContext, IConfiguration config)
        {
            _context = context;
